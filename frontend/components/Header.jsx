...
import group_pfp from '../assets/assets_frontend/group_profiles.png'
    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6FFF] rounded-lg px-6 md:px-10 lg:px-20 '>
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                <img className='w-28 ' src={group_pfp} alt="" />
                <p>Simply browse through our etensive list of trusted doctors, <br className='hidden lg:block' /> schedule your appointment hassle-free.</p>
            </div>
        ...
        <div className='md:w-1/2 relative'>
            <img className='md:absolute bottom-0 h-auto rounded-lg' src={header} alt="" />
        </div>
